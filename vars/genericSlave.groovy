...
def call(body) {
	...
	docker run --name jenkins_slave jenkins/jnlp-slave -url http://192.168.2.127:8080 05d9f81216df782f70cef38ff2ae25030c18188c27a36e6cea138ab3b6b14048 jenkins-slave &
	sleep 30
	node ('slave') {
	//dockerNode('jnlp'){
		//sleep 30
