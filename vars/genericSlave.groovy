...
def call(body) {
	...
	node{
		...
		sh "docker run -d --rm --name ${containerID} jenkins/jnlp-slave -v /var/run/docker.sock:/var/run/docker.sock -url http://192.168.2.127:8080 -workDir=/home/jenkins/agent 05d9f81216df782f70cef38ff2ae25030c18188c27a36e6cea138ab3b6b14048 jenkins-slave -Dorg.jenkinsci.remoting.engine.JnlpProtocol3.disabled=false &"
